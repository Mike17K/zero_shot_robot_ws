...
def setupNode(args=None) -> Node:
    """The CLI's node. Parameters: namespace (robot_1), world_frame (world),
    tool_frame (gripper_tcp), controller (gp70l_joint_trajectory_controller)."""
    rclpy.init(args=args)
    node = Node('navigator_cli')
